...
// ✔️ Use o import da logo em TODOS os lugares
...
export default function App() {
  ...
  const handleAnalyze = async (refining = false) => {
    ...
    try {
      const prompt =
        "Realize uma análise orquestrada multimodal completa destes arquivos.";
  ...
  return (
    <div className="min-h-screen bg-black text-slate-100 font-sans flex flex-col relative">
            ...
            {!result && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <p className="text-brand-400 text-xs font-bold uppercase tracking-[0.3em] px-2">
                    Entrada 01: Visão
                  </p>
            ...
            {result && (
              <div ref={resultRef} className="space-y-8 animate-in fade-in slide-in-from-bottom-12 duration-1000">
                <div className="glass-card rounded-[48px] p-8 md:p-16 shadow-3xl">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 border-b border-white/10 pb-10">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-brand-600 hover:bg-brand-500 text-white rounded-2xl text-sm font-bold transition-all"
                      >
                        <RotateCcw size={18} />
                        NOVA ANÁLISE
                      </button>
                  ...
                  {isEditing && (
                    <div className="mb-10 p-6 bg-brand-500/5 border border-brand-500/20 rounded-3xl">
                      <p className="text-brand-400 text-sm font-bold mb-3 uppercase tracking-wider">
                        O que deseja alterar na análise?
                      </p>
                      ...
                      <div className="flex gap-4">
                        <input
                          ...
                          className="flex-grow bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500"
                        ...
                        <button
                          ...
                          className="bg-brand-500 hover:bg-brand-400 disabled:opacity-50 text-white p-3 rounded-xl"
                        >
                          <Send size={20} />
                        </button>
                      </div>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-10 right-10 z-[100] p-5 bg-white/10 backdrop-blur-2xl border border-white/20 rounded-full transition-all ${
        ...
        <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-10">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-4 text-3xl font-black text-white">
              {/* ✔️ Agora usa a logo importada (sem risco de caminho quebrar) */}
              <img
                src={logo}
                alt="Logo"
          ...
          <div className="flex gap-4">
            <a href="https://github.com/matewanga_" target="_blank" className="p-5 bg-white/5 rounded-3xl">
              <Github size={24} />
            </a>
            <a href="https://linkedin.com/in/matewanga_" target="_blank" className="p-5 bg-white/5 rounded-3xl">
              <Linkedin size={24} />
            </a>
          </div>
